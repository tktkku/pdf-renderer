...
static pdf_code_range_map_t code_range_map_KSCPC_EUC_H[] = {
    {1, 0x00, 0x84},
    {2, 0xa141, 0xfdfe},
    {1, 0xfe, 0xff},
};

static pdf_char_range_map_t not_def_range_KSCPC_EUC_H[] = {
    {0x00, 0x1f, 0x1},
};

static pdf_char_range_map_t char_range_map_KSCPC_EUC_H[] = {
    {0x20, 0x7e, 0x1},
    {0x81, 0x83, 0x60},
...
pdf_cmap_t cmap_KSCPC_EUC_H = {
    .name = "KSCpc-EUC-H",
    .worldwide = true,
    .unicode_map_len = 0,
    .unicode_map = NULL,
    .char_range_map_len = 509,
    .char_range_map = char_range_map_KSCPC_EUC_H,
    .not_def_range_len = 1,
    .not_def_range = not_def_range_KSCPC_EUC_H,
    .code_range_map_len = 3,
    .code_range_map = code_range_map_KSCPC_EUC_H,
    .next = NULL
};
