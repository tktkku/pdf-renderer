...
static pdf_code_range_map_t code_range_map_CNS_EUC_H[] = {
    {1, 0x00, 0x80},
...
static pdf_char_range_map_t not_def_range_CNS_EUC_H[] = {
    {0x00, 0x1f, 0x3550},
};

static pdf_char_range_map_t char_range_map_CNS_EUC_H[] = {
    {0x20, 0x7e, 0x3550},
...
pdf_cmap_t cmap_CNS_EUC_H = {
    .name = "CNS-EUC-H",
    .worldwide = true,
    .unicode_map_len = 0,
    .unicode_map = NULL,
    .char_range_map_len = 395,
    .char_range_map = char_range_map_CNS_EUC_H,
    .not_def_range_len = 1,
    .not_def_range = not_def_range_CNS_EUC_H,
    .code_range_map_len = 5,
    .code_range_map = code_range_map_CNS_EUC_H,
    .next = NULL
};
