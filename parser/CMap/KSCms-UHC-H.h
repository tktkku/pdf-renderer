...
static pdf_code_range_map_t code_range_map_KSCMS_UHC_H[] = {
    {1, 0x00, 0x80},
    {2, 0x8141, 0xfefe},
};

static pdf_char_range_map_t not_def_range_KSCMS_UHC_H[] = {
    {0x00, 0x1f, 0x1},
};

static pdf_char_range_map_t char_range_map_KSCMS_UHC_H[] = {
    {0x20, 0x7e, 0x1},
...
pdf_cmap_t cmap_KSCMS_UHC_H = {
    .name = "KSCms-UHC-H",
    .worldwide = true,
    .unicode_map_len = 0,
    .unicode_map = NULL,
    .char_range_map_len = 675,
    .char_range_map = char_range_map_KSCMS_UHC_H,
    .not_def_range_len = 1,
    .not_def_range = not_def_range_KSCMS_UHC_H,
    .code_range_map_len = 2,
    .code_range_map = code_range_map_KSCMS_UHC_H,
    .next = NULL
};
