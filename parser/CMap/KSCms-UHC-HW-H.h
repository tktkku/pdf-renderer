...
static pdf_code_range_map_t code_range_map_KSCMS_UHC_HW_H[] = {
    {1, 0x00, 0x80},
    {2, 0x8141, 0xfefe},
};

static pdf_char_range_map_t not_def_range_KSCMS_UHC_HW_H[] = {
    {0x00, 0x1f, 0x1f9e},
};

static pdf_char_range_map_t char_range_map_KSCMS_UHC_HW_H[] = {
    {0x20, 0x7e, 0x1f9e},
...
pdf_cmap_t cmap_KSCMS_UHC_HW_H = {
    "KSCms-UHC-HW-H",    //name
    true,        //worldwide
    0,      //unicode_map_len
    NULL,      //unicode_map
    675,   //char_range_map_len
    char_range_map_KSCMS_UHC_HW_H,   //char_range_map
    1,       //not_def_range_len
    not_def_range_KSCMS_UHC_HW_H,       //not_def_range
    2,    //code_range_map_len
    code_range_map_KSCMS_UHC_HW_H,    //code_range_map
     NULL//next
};
