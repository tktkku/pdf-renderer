...
pdf_cmap_t cmap_KSCMS_UHC_HW_H = {
    ...
    .unicode_map_len = 0,
    .unicode_map = NULL,
    .char_range_map_len = 675,
    .char_range_map = char_range_map_KSCMS_UHC_HW_H,
    .not_def_range_len = 1,
    .not_def_range = not_def_range_KSCMS_UHC_HW_H,
    .code_range_map_len = 2,
    .code_range_map = code_range_map_KSCMS_UHC_HW_H,
    .next = NULL
};
