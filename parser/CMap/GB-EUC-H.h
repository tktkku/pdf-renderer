...
static pdf_code_range_map_t code_range_map_GB_EUC_H[] = {
    {1, 0x00, 0x80},
    {2, 0xa1a1, 0xfefe},
};

static pdf_char_range_map_t not_def_range_GB_EUC_H[] = {
    {0x00, 0x1f, 0x1e24},
};

static pdf_char_range_map_t char_range_map_GB_EUC_H[] = {
    {0x20, 0x20, 0x1e24},
    {0x21, 0x7e, 0x32e},
    {0xa1a1, 0xa1fe, 0x60},
    {0xa2b1, 0xa2e2, 0xbe},
...
pdf_cmap_t cmap_GB_EUC_H = {
    .name = "GB-EUC-H",
    .worldwide = true,
    .unicode_map_len = 0,
    .unicode_map = NULL,
    .char_range_map_len = 90,
    .char_range_map = char_range_map_GB_EUC_H,
    .not_def_range_len = 1,
    .not_def_range = not_def_range_GB_EUC_H,
    .code_range_map_len = 2,
    .code_range_map = code_range_map_GB_EUC_H,
    .next = NULL
};
