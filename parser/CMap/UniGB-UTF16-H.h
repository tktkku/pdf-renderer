...
static pdf_code_range_map_t code_range_map_UNIGB_UTF16_H[] = {
    {2, 0x0000, 0xd7ff},
    {4, 0xd800dc00, 0xdbffdfff},
    {2, 0xe000, 0xffff},
};

static pdf_char_range_map_t not_def_range_UNIGB_UTF16_H[] = {
    {0x0000, 0x001f, 0x1},
};

static pdf_unicode_map_t unicode_map_UNIGB_UTF16_H[] = {
    {0x1, 0x00a0},
    {0xa7, 0x00a4},
    {0x5752, 0x00a5},
    {0xab, 0x00a7},
...
static pdf_char_range_map_t char_range_map_UNIGB_UTF16_H[] = {
    {0x0020, 0x007e, 0x1},
    {0x02ca, 0x02cb, 0x26b3},
    {0x0391, 0x03a1, 0x20d},
    {0x03a3, 0x03a9, 0x21e},
    {0x03b1, 0x03c1, 0x225},
    {0x03c3, 0x03c9, 0x236},
    ...
    {0x3474, 0x34ff, 0x5873},
    {0x3500, 0x359d, 0x58ff},
    {0x359f, 0x35ff, 0x599d},
    {0x3600, 0x360d, 0x59fe},
    {0x360f, 0x3619, 0x5a0c},
    {0x361b, 0x36ff, 0x5a17},
    {0x3700, 0x37ff, 0x5afc},
    {0x3800, 0x38ff, 0x5bfc},
    {0x3900, 0x3917, 0x5cfc},
    {0x3919, 0x396d, 0x5d14},
    {0x396f, 0x39ce, 0x5d69},
    {0x39d1, 0x39de, 0x5dc9},
    {0x39e0, 0x39ff, 0x5dd7},
    {0x3a00, 0x3a72, 0x5df7},
    {0x3a74, 0x3aff, 0x5e6a},
    {0x3b00, 0x3b4d, 0x5ef6},
    {0x3b4f, 0x3bff, 0x5f44},
    {0x3c00, 0x3c6d, 0x5ff5},
    {0x3c6f, 0x3cdf, 0x6063},
    {0x3ce1, 0x3cff, 0x60d4},
    {0x3d00, 0x3dff, 0x60f3},
    {0x3e00, 0x3eff, 0x61f3},
    {0x3f00, 0x3fff, 0x62f3},
    {0x4000, 0x4055, 0x63f3},
    {0x4057, 0x40ff, 0x6449},
    {0x4100, 0x415e, 0x64f2},
    {0x4160, 0x41ff, 0x6551},
    {0x4200, 0x42ff, 0x65f1},
    {0x4300, 0x4336, 0x66f1},
    {0x4338, 0x43ab, 0x6728},
    {0x43ad, 0x43b0, 0x679c},
    {0x43b2, 0x43dc, 0x67a0},
    {0x43de, 0x43ff, 0x67cb},
    {0x4400, 0x44d5, 0x67ed},
    {0x44d7, 0x44ff, 0x68c3},
    {0x4500, 0x45ff, 0x68ec},
    {0x4600, 0x464b, 0x69ec},
    {0x464d, 0x4660, 0x6a38},
    {0x4662, 0x46ff, 0x6a4c},
    {0x4700, 0x4722, 0x6aea},
    {0x4724, 0x4728, 0x6b0d},
    {0x472a, 0x477b, 0x6b12},
    {0x477d, 0x478c, 0x6b64},
    {0x478e, 0x47ff, 0x6b74},
    {0x4800, 0x48ff, 0x6be6},
    {0x4900, 0x4946, 0x6ce6},
    ...
    {0x49b8, 0x49ff, 0x6d93},
    {0x4a00, 0x4aff, 0x6ddb},
    {0x4b00, 0x4bff, 0x6edb},
    {0x4c00, 0x4c76, 0x6fdb},
    {0x4c78, 0x4c9e, 0x7052},
    {0x4c9f, 0x4ca1, 0x5661},
    {0x4ca4, 0x4cff, 0x7079},
    {0x4d00, 0x4d12, 0x70d5},
    {0x4d13, 0x4d19, 0x5666},
    {0x4d1a, 0x4dad, 0x70e8},
    {0x4daf, 0x4db5, 0x717c},
    {0x4db6, 0x4dbf, 0x769e},
    ...
    {0x58fe, 0x58ff, 0x2d24},
    {0x5900, 0x5901, 0x2d26},
    ...
    {0x5cfe, 0x5cff, 0x2f8b},
    {0x5d00, 0x5d01, 0x2f8d},
    ...
    {0x6afc, 0x6aff, 0x37d0},
    {0x6b00, 0x6b03, 0x37d4},
    ...
    {0x6dfd, 0x6dff, 0x3973},
    {0x6e00, 0x6e04, 0x3976},
    ...
    {0x70fe, 0x70ff, 0x3b53},
    {0x7100, 0x7108, 0x3b55},
    ...
    {0x7dfc, 0x7dff, 0x436d},
    {0x7e00, 0x7e07, 0x4371},
    ...
    {0x80fe, 0x80ff, 0x44d1},
    {0x8100, 0x8101, 0x44d3},
    ...
    {0x8dfe, 0x8dff, 0x4c1d},
    {0x8e00, 0x8e04, 0x4c1f},
    ...
    {0x93fa, 0x93ff, 0x4f7d},
    {0x9400, 0x9402, 0x4f83},
    ...
    {0x9afc, 0x9aff, 0x5305},
    {0x9b00, 0x9b02, 0x5309},
    ...
    {0x9cf7, 0x9cff, 0x544b},
    {0x9d00, 0x9d05, 0x5454},
    ...
    {0x9dfb, 0x9dff, 0x551b},
    {0x9e00, 0x9e0b, 0x5520},
    ...
    {0x9fa6, 0x9fb3, 0x764c},
    {0x9fb6, 0x9fb7, 0x5635},
    {0x9fbc, 0x9fff, 0x765a},
    {0xa000, 0xa0ff, 0x7188},
    {0xa100, 0xa1ff, 0x7288},
    {0xa200, 0xa2ff, 0x7388},
    {0xa300, 0xa3ff, 0x7488},
    {0xa400, 0xa48c, 0x7588},
    {0xa490, 0xa4c6, 0x7615},
    {0xd84fdc97, 0xd84fdc98, 0x76ae},
    {0xd86cdd27, 0xd86cdd28, 0x76d3},
    {0xd86cdd37, 0xd86cdd38, 0x76d5},
    {0xd86ddd0d, 0xd86ddd0e, 0x76e5},
    {0xd86dddae, 0xd86dddaf, 0x76e8},
    {0xd86dde1c, 0xd86dde1d, 0x76ed},
    {0xd86dde26, 0xd86dde28, 0x76ef},
    {0xd86dde95, 0xd86dde96, 0x76f4},
    {0xd870dc29, 0xd870dc2a, 0x770b},
    {0xd871de2b, 0xd871de2d, 0x7721},
    {0xd871de4a, 0xd871de4b, 0x7726},
    {0xd872df2d, 0xd872df2e, 0x7739},
    {0xd872df38, 0xd872df39, 0x773c},
    {0xd872df5a, 0xd872df5b, 0x7743},
    {0xd872dfbf, 0xd872dfc0, 0x774e},
    {0xd873dcf5, 0xd873dcf6, 0x7753},
    {0xd873dd02, 0xd873dd03, 0x7757},
    {0xd873dd8f, 0xd873dd90, 0x775c},
    {0xd873dd9f, 0xd873dda0, 0x775e},
    {0xd873ddad, 0xd873ddae, 0x7761},
    {0xe78d, 0xe793, 0x23d},
    {0xe794, 0xe795, 0x250},
    {0xe7e7, 0xe7f3, 0x274b},
    {0xe815, 0xe864, 0x561f},
...
pdf_cmap_t cmap_UNIGB_UTF16_H = {
    .name = "UniGB-UTF16-H",
    .worldwide = true,
    .unicode_map_len = 10925,
    .unicode_map = unicode_map_UNIGB_UTF16_H,
    .char_range_map_len = 3137,
    .char_range_map = char_range_map_UNIGB_UTF16_H,
    .not_def_range_len = 1,
    .not_def_range = not_def_range_UNIGB_UTF16_H,
    .code_range_map_len = 3,
    .code_range_map = code_range_map_UNIGB_UTF16_H,
    .next = NULL
};
