...
static pdf_code_range_map_t code_range_map_UNIJIS_UCS2_H[] = {
    {2, 0x0000, 0xd7ff},
    {2, 0xe000, 0xffff},
};

static pdf_char_range_map_t not_def_range_UNIJIS_UCS2_H[] = {
    {0x0000, 0x001f, 0x1},
};

static pdf_char_range_map_t char_range_map_UNIJIS_UCS2_H[] = {
    {0x0020, 0x005b, 0x1},
    {0x005c, 0x005c, 0x61},
    {0x005d, 0x007e, 0x3e},
    {0x00a1, 0x00a3, 0x65},
    ...
    {0x00f8, 0x00f8, 0x94},
    {0x00f9, 0x00ff, 0xd8},
    {0x0100, 0x0100, 0x2496},
    {0x0101, 0x0101, 0x2491},
    {0x0112, 0x0112, 0x2499},
    {0x0113, 0x0113, 0x2494},
    {0x011a, 0x011a, 0x24b3},
    {0x011b, 0x011b, 0x24bf},
    {0x0127, 0x0127, 0x2f3c},
    {0x0128, 0x0128, 0x24b8},
    {0x0129, 0x0129, 0x24c4},
    {0x012a, 0x012a, 0x2497},
    {0x012b, 0x012b, 0x2492},
    {0x0131, 0x0131, 0x92},
    {0x0141, 0x0141, 0x8d},
    {0x0142, 0x0142, 0x93},
    {0x014b, 0x014b, 0x24dc},
    {0x014c, 0x014c, 0x249a},
    {0x014d, 0x014d, 0x2495},
    {0x0152, 0x0152, 0x8f},
    {0x0153, 0x0153, 0x95},
    {0x0160, 0x0160, 0xdf},
    {0x0161, 0x0161, 0xe3},
    {0x0168, 0x0168, 0x24bd},
    {0x0169, 0x0169, 0x24c9},
    {0x016a, 0x016a, 0x2498},
    {0x016b, 0x016b, 0x2493},
    {0x016e, 0x016e, 0x24bc},
    {0x016f, 0x016f, 0x24c8},
    {0x0178, 0x0178, 0xe0},
    {0x017d, 0x017d, 0xe1},
    {0x017e, 0x017e, 0xe5},
    {0x01c0, 0x01c0, 0x63},
    {0x01cd, 0x01cd, 0x24b2},
    {0x01ce, 0x01ce, 0x24be},
    {0x01cf, 0x01cf, 0x24b6},
    {0x01d0, 0x01d0, 0x24c2},
    {0x01d1, 0x01d1, 0x24b9},
    {0x01d2, 0x01d2, 0x24c5},
    {0x01d3, 0x01d3, 0x24bb},
    {0x01d4, 0x01d4, 0x24c7},
    {0x01fd, 0x01fd, 0x24cd},
    {0x0251, 0x0251, 0x24ca},
    {0x0254, 0x0254, 0x24cf},
    {0x0259, 0x0259, 0x24d2},
    {0x025a, 0x025a, 0x24d5},
    {0x025b, 0x025b, 0x24d8},
    {0x0275, 0x0275, 0x24dd},
    {0x0283, 0x0283, 0x24e2},
    {0x028c, 0x028c, 0x24de},
    {0x0292, 0x0292, 0x24e1},
    {0x02d0, 0x02d0, 0x24e3},
    {0x0300, 0x0300, 0x41},
    {0x0301, 0x0302, 0x7f},
    {0x0303, 0x0303, 0x5f},
    {0x0304, 0x0304, 0x81},
    ...
    {0x03b1, 0x03c1, 0x40b},
    {0x03c3, 0x03c9, 0x41c},
    {0x03d0, 0x03d0, 0x2f3a},
    {0x03d1, 0x03d1, 0x2f40},
    {0x03db, 0x03db, 0x2f3f},
    {0x0401, 0x0401, 0x429},
    {0x0410, 0x0415, 0x423},
    {0x0416, 0x0435, 0x42a},
    {0x0436, 0x044f, 0x44b},
    {0x0451, 0x0451, 0x44a},
    {0x045b, 0x045b, 0x2f3c},
...
pdf_cmap_t cmap_UNIJIS_UCS2_H = {
    "UniJIS-UCS2-H",    //name
    true,        //worldwide
    0,      //unicode_map_len
    NULL,      //unicode_map
    8533,   //char_range_map_len
    char_range_map_UNIJIS_UCS2_H,   //char_range_map
    1,       //not_def_range_len
    not_def_range_UNIJIS_UCS2_H,       //not_def_range
    2,    //code_range_map_len
    code_range_map_UNIJIS_UCS2_H,    //code_range_map
     NULL//next
};
