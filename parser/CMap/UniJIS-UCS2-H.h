...
pdf_cmap_t cmap_UNIJIS_UCS2_H = {
    ...
    .unicode_map_len = 0,
    .unicode_map = NULL,
    .char_range_map_len = 8533,
    .char_range_map = char_range_map_UNIJIS_UCS2_H,
    .not_def_range_len = 1,
    .not_def_range = not_def_range_UNIJIS_UCS2_H,
    .code_range_map_len = 2,
    .code_range_map = code_range_map_UNIJIS_UCS2_H,
    .next = NULL
};
